...
<nav class="border-b border-blue-900/30 bg-[#1e3a5f] sticky top-0 z-50">
            ...
            <div class="flex items-center gap-3 relative">
                @auth
                    ...
                    <button type="button" id="theme-toggle-btn"
                        class="flex items-center justify-center w-9 h-9 text-gray-400 hover:text-white bg-white/10 hover:bg-white/20 rounded-lg transition"
                    ...
                    <div id="user-menu-dropdown"
                        class="hidden absolute top-full right-0 mt-2 bg-[#131928] dark:bg-[#131928] border border-white/10 dark:border-white/10 rounded-lg shadow-2xl z-50 w-48 py-1">
                        ...
                        @if (Auth::user()->is_admin)
                            <a href="{{ route('filament.admin.pages.dashboard') }}"
                                class="block px-4 py-2.5 text-sm text-blue-400 hover:text-blue-300 hover:bg-blue-500/10 transition font-semibold">
                                🔐 Admin panel
                            </a>
