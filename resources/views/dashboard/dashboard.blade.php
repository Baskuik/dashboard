    ...
    <main class="min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
            ...
            <div class="mb-6 sm:mb-8">
                <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-white">Overzicht</h1>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Milieu-check registraties en statistieken</p>
            </div>
            ...
            <div class="border border-white/8 bg-[#131928] rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Importeer milieu-check records (.xlsx, .xls – max 10 MB)
                        </p>
                    </div>
                </div>
                ...
                <form id="upload-form" method="POST" action="{{ route('upload.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
                        <label for="file"
                            class="flex-1 flex items-center gap-3 px-4 py-3 border border-dashed border-white/15 rounded-lg cursor-pointer hover:border-blue-500/40 hover:bg-blue-500/5 transition min-h-[48px]">
                            <svg class="w-5 h-5 text-blue-400 shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                            <span id="file-label" class="text-xs sm:text-sm text-gray-400">Klik om bestand te
                                selecteren</span>
                        ...
                        <button type="submit"
                            class="sm:shrink-0 px-4 sm:px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition min-h-[48px]">
                            Uploaden
                        </button>
                    </div>
                </form>
                ...
                <div id="confirm-modal-backdrop"
                    class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-40 transition-opacity duration-200">
                </div>
            ...
            @if (empty($selectedWidgets))
                <div
                    ...
                    <p class="text-gray-400 mb-8 max-w-md">Je hebt nog geen widgets geselecteerd voor je dashboard.
                        Kies
