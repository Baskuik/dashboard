...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <a href="{{ route('records.by-action') }}"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="w-8 h-8 bg-blue-500/15 rounded-lg flex items-center justify-center group-hover:bg-blue-500/25 transition">
    ...
    <a href="{{ route('records.by-cost') }}"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="w-8 h-8 bg-cyan-500/15 rounded-lg flex items-center justify-center group-hover:bg-cyan-500/25 transition">
        ...
        <div>
            <p class="text-3xl font-semibold text-white mono">€ {{ number_format($stats['total_cost'] ?? 0, 0, ',', '.') }}</p>
    ...
    <a href="{{ route('records.by-duration') }}"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="w-8 h-8 bg-emerald-500/15 rounded-lg flex items-center justify-center group-hover:bg-emerald-500/25 transition">
        ...
        <div>
            <p class="text-3xl font-semibold text-white mono">{{ number_format($stats['avg_duration'] ?? 0, 1, ',', '.') }}u</p>
    ...
    <a href="{{ route('records.by-employee') }}"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="w-8 h-8 bg-violet-500/15 rounded-lg flex items-center justify-center group-hover:bg-violet-500/25 transition">
